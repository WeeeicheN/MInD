...
from create_dataset import Create_MOSEI
import numpy as np
import random
import pickle
import torch
...
class MOSEI_Loader(object):
    def __init__(self, configs, train_drop_last=False, valid_drop_last=False, test_drop_last=False):
        ...
        self.train_dataset = MOSEI(configs, mode='train')
        self.valid_dataset = MOSEI(configs, mode='valid')
        self.test_dataset = MOSEI(configs, mode='test')
